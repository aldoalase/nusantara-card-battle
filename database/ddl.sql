...
CREATE TABLE `card` (
  ...
  `CARD_STRENGTH` int(11) DEFAULT NULL,
  `CARD_DEFENSE` int(11) DEFAULT NULL,
  `CARD_HP` int(11) DEFAULT NULL,
  `CARD_LEVEL` int(11) DEFAULT NULL,
  `CARD_TIPE` int(11) DEFAULT NULL,
  `CARD_MAGIC_NUMBER` int(11) DEFAULT NULL,
  `ENCHANT_STRENGTH` int(11) DEFAULT NULL,
  `ENCHANT_DEFENSE` int(11) DEFAULT NULL,
  `ENCHANT_HP` int(11) DEFAULT NULL,
...
CREATE TABLE `player` (
  ...
  `PLAYER_WIN` int(11) DEFAULT NULL,
  `PLAYER_LOSE` int(11) DEFAULT NULL,
  `PLAYER_MONEY` decimal(10,0) DEFAULT NULL,
