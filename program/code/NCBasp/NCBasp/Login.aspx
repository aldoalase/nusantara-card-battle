...
<h2>
    ...
    <p>
        <asp:Label ID="UserNameLabelLogin" runat="server" AssociatedControlID="UserNameLoginBox">Username:</asp:Label>
    ...
    <p>
        <asp:Label ID="PasswordLabelLogin" runat="server" AssociatedControlID="PasswordLoginBox">Password:</asp:Label>
