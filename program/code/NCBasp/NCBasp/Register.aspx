...
<h2>
    ...
    <p>
        <asp:Label ID="UserNameLabelRegister" runat="server" AssociatedControlID="UserNameRegisterBox">Username:</asp:Label>
    ...
    *</p>
    <p>
        <asp:Label ID="PasswordLabelRegister" runat="server" AssociatedControlID="PasswordRegisterBox">Password:</asp:Label>
    ...
    *</p>
    <p>
        <asp:Label ID="PasswordLabelRegister2" runat="server" AssociatedControlID="PasswordRegisterBox2">Confirm Password:</asp:Label>
